...
class HexConverterTest {
    ...
    void testToHexString4() {
        ...
        //
        byte b = 100;
        String string = com.ltsllc.commons.HexConverter.toHexString(b);
    ...
    void testToHexString() {
        ...
        String string = null;
        try {
            string = com.ltsllc.commons.HexConverter.toHexString(inputStreamReader);
        } catch (IOException e) {
    ...
    void testToByteArray() {
        ...
        byte[] bytes = com.ltsllc.commons.HexConverter.toByteArray(string);
    ...
    void testToHexString2 () {
        ...
        String string = com.ltsllc.commons.HexConverter.toHexString(baos.toByteArray());
